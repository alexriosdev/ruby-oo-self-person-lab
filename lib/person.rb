class Person
  ...
  def get_paid(salary)
	...
	def hygiene_adjuster(hygiene, difference)		
		self.hygiene = @hygiene + difference
	end
  ...
  def take_bath
	...
	def happiness_adjuster(happiness, difference)		
		self.happiness = @happiness + difference
	end
	...
	def call_friend(person)
		...
		person.happiness_adjuster(happiness, 3)
	...
	def start_conversation(person, topic)
		if topic == "politics"
			...
			person.happiness_adjuster(happiness, -2)
			return "blah blah partisan blah lobbyist"
		elsif topic == "weather"
			self.happiness_adjuster(happiness, 1)
			person.happiness_adjuster(happiness, 1)
